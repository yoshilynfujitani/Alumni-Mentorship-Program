    ...
    <div class="my-10 flex justify-center flex-col items-center w-full">
        ...
        <div class="w-fit" v-if="this.allowToAppoint === 2">
            <Message severity="warn">
                You have already sent an appointment request to a mentor. Please
                wait before sending another one.</Message
            >
        </div>
        <div
            class="bg-white border border-gray-200 rounded-md p-2.5 md:p-5 my-5 w-full"
        >
            <div class="md:mx-5 mb-2.5 text-lg font-semibold text-green-700">
            ...
            <div
                class="grid grid-cols-1 tablet:grid-cols-3 laptop:grid-cols-4 desktop:grid-cols-6"
            >
                ...
                <div class="md:mx-5 my-1" v-for="Mentor in mentors" v-else>
                    <MentorCard
                        ...
                        :displaybtn="
                            this.allowToAppoint === 1 && !Mentor.hasAppointment
                        "
                    />
                </div>
            </div>
